...
public class ChatListServiceImpl implements ChatListService {
    ...
    public void saveChatList(User user1, User user2) {
        if(chatListRepoService.checkChat(user1.getUserId(),user2.getUserId())) {
            ...
            String avtext = sender.getFirstName().charAt(0)+""+sender.getLastName().charAt(0);
            ...
            avtext = receiver.getFirstName().charAt(0)+""+receiver.getLastName().charAt(0);
